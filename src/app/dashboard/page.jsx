...
//       <DashboardSidebar isOpen={sidebarOpen} activeTab={activeTab} setActiveTab={setActiveTab} />
//        {sidebarOpen && (
//         <div
...
export default async function DashboardRoute() {
  ...
  const [cats, exps] = await Promise.all([
    database.listDocuments(DB_ID, CAT_COL, [Query.equal("userId", user.$id)]),
    database.listDocuments(DB_ID, EXP_COL, [Query.equal("userId", user.$id)]),
  ]);
  return (
    <DashboardPage
      user={user}
      categories={cats.documents}
      expenses={exps.documents}
    />
  );
}
